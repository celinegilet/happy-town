...
readonly UNAUTHORIZED_PACKAGES_USAGE_IN_USE_CASES="dataproviders|entrypoints"
readonly UNAUTHORIZED_PACKAGES_USAGE_IN_DOMAIN="${UNAUTHORIZED_PACKAGES_USAGE_IN_USE_CASES}|use_cases|springframework|javax"

readonly UNAUTHORIZED_PACKAGES_USAGE_COUNT_IN_ENTITIES=$(find ${ENTITIES_PACKAGE_PATH} -name "*.java" -exec egrep -w ${UNAUTHORIZED_PACKAGES_USAGE_IN_DOMAIN} {} \; | wc -l)
...
find ${ENTITIES_PACKAGE_PATH} -name "*.java" -exec egrep -lw ${UNAUTHORIZED_PACKAGES_USAGE_IN_DOMAIN} {} \;
echo ""
